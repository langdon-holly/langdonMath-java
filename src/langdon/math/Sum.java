...
//                 if (debug) System.err.println("Sum.simplify: (2 Expr): -1 == -1: " + Number.make(-1d).equalsExpr(Number.make(-1d)));
                ...
                if (expr1OtherThing.equalsExpr(expr2OtherThing)) {
                    ...
                    i = -1;
                      ...
                      && ((Operation) expr1OtherThing).getExpr(1).equalsExpr(Number.make(2)) && ((Operation) expr2OtherThing).getExpr(1).equalsExpr(Number.make(2))
...
//                 }
        ...
        for (int i = 0; i < constants.size(); i++) {
            ...
            Double number1 = null;
            if (constant1 instanceof Number) number1 = ((Number) constant1).val();
            ...
            Expr constant1Mult = Number.make(1);
...
//             }
            ...
            for (int j = 0; j < constants.size(); j++) {
                if (i != j) {
                    ...
                    Double number2 = null;
                    if (constant2 instanceof Number) number2 = ((Number) constant2).val();
                    ...
                    Expr constant2Mult = Number.make(1);
                    ...
                    if (number1 != null && number2 != null && number1 + number2 - number1 - number2 == 0 && number2 + number1 - number2 - number1 == 0) {
                        constants.set(i, Number.make(number1 + number2));
                        combined = true;
                        ...
                        combined = true;
                    } else if (constant1OtherThing.equalsExpr(constant2OtherThing) && !constant1OtherThing.equalsExpr(Number.make(1))) {
