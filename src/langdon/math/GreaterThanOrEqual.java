...
public class GreaterThanOrEqual extends Comparison {
    ...
    public GreaterThanOrEqual(Expr expr1, Expr expr2) {
        this.expr1 = expr1;
        this.expr2 = expr2;
    }
    
    public static Expr make(Expr expr1, Expr expr2) {
        return new GreaterThanOrEqual(expr1, expr2).simplify();
    }
    
    public static Expr make(ArrayList<? extends Expr> exprs) {
        if (exprs.size() <= 2) return make(exprs.get(0), exprs.get(1));
        throw new UnsupportedOperationException("GreaterThanOrEqual chaining");
    }
    ...
    public Expr simplify() {
        ...
        return Or.make(GreaterThan.make(expr1, expr2), Equals.make(expr1, expr2));
    }
